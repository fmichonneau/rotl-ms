...
Scott Chamberlain (rOpenSci) for providing a thorough code review and 
Shinichi Nakagawa and Alistair Senior for their help in developing the package's
meta-analysis vignette. DJW was supported by  NIH Grant R01-GM101352. SFM was
