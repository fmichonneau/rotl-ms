...
\citep{Boettiger2012}, \texttt{rAvis} \citep{Varela2014}, and \texttt{paleobioDB}
...
manuscript, and Shinichi Nakagawa and Alistair Senior for their help in
developing the package's meta-analysis vignette. DJW was supported by NIH Grant
R01-GM101352. FM was supported by iDigBio, and therefore this material is based
upon work supported by the National Science Foundation’s Advancing Digitization
of Biodiversity Collections Program (Cooperative Agreement EF-1115210).
